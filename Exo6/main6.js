...
let prixArticle = parseFloat(prompt("Entrer le prix HT de l'article"));
let quantitArticle = parseInt(prompt("Entrer la quantité de l'article"));
*/

let articles= [prompt("Saisir le nom de l'article"), parseFloat(prompt("Saisie le prix HT")), parseInt(prompt("Entrer la quantité de l'article"))]
